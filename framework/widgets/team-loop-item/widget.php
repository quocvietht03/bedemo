<?php
namespace BeDemoElementorWidgets\Widgets\TeamLoopItem;
...
class Widget_TeamLoopItem extends Widget_Base {
	...
	public function get_title() {
		return __( 'Team Loop Item', 'bedemo' );
	}
	...
	protected function register_style_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bt-post--prf-link' => 'color: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'prf_link_color_hover',
			[
				'label' => __( 'Color Hover', 'bedemo' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'prf_link_typography',
				'label' => __( 'Typography', 'bedemo' ),
				'default' => '',
				'selector' => '{{WRAPPER}} .bt-post--prf-link',
			]
		);
	...
	protected function render() {
		...
		?>
			<div class="bt-elwg-team-loop-item--default">
