<?php
namespace BeDemoElementorWidgets\Widgets\SiteInformation;
...
class Widget_SiteInformation extends Widget_Base {
	...
	public function get_title() {
		return __( 'Site Information', 'bedemo' );
	}
	...
	protected function register_content_section_controls() {
		...
		$this->add_control(
			'list',
			[
				'label' => esc_html__( 'Show Elements', 'bedemo' ),
				'type' => Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple' => true,
				'options' => [
					'phone'  => esc_html__( 'Phone', 'bedemo' ),
					'email' => esc_html__( 'Email', 'bedemo' ),
					'address' => esc_html__( 'Address', 'bedemo' ),
				],
				'default' => [ 'phone', 'email' ],
			]
		);
	...
	protected function register_layout_section_controls() {
		...
		$this->add_control(
			'style',
			[
				'label' => esc_html__( 'Layout Style', 'bedemo' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'column' => [
						'title' => esc_html__( 'Block', 'bedemo' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'row' => [
						'title' => esc_html__( 'Inline', 'bedemo' ),
