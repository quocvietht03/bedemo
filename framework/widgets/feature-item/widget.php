<?php
namespace BeDemoElementorWidgets\Widgets\FeatureItem;
...
class Widget_FeatureItem extends Widget_Base {

	public function get_name() {
		return 'bt-feature-item';
	}

	public function get_title() {
		return __( 'Feature Item', 'bedemo' );
	}
	...
	protected function render() {
		...
		$attachment = wp_get_attachment_image_src($settings['image']['id'], 'full');
		if (!empty($attachment)) {
		...
		?>
			<div class="bt-elwg-feature-item--default">
				<div class="bt-feature--item">
					<div class="bt-feature--image">
						<?php echo '<div class="bt-contain-image">' . $image . '</div>'; ?>
					</div>
					<?php 
						if(!empty($settings['title'])) {
							if(!empty($settings['link'])) {
								echo '<h3 class="bt-feature--title">
										<a href="' . esc_url($settings['link']) . '">' . $settings['title'] . '</a>
									</h3>';
							} else {
								echo '<h3 class="bt-feature--title">' . $settings['title'] . '</h3>';
							}
						}
					?>
				</div>
