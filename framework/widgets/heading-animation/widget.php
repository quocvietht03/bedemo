...
namespace BeDemoElementorWidgets\Widgets\HeadingAnimation;
...
class Widget_HeadingAnimation extends Widget_Base
{
	...
	{
		return __('Heading Animation', 'bedemo');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'animation_text',
			[
				'label'       => esc_html__('Heading Animation', 'bedemo'),
				'type'        => Controls_Manager::TEXTAREA,
				'label_block' => true,
				'default'     => esc_html__('Animation', 'bedemo'),
			]
		);
		...
		$this->add_control(
			'entrance_animation',
			[
				'label' => esc_html__( 'Entrance Animation', 'bedemo' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => [
					'none' => esc_html__( 'None', 'bedemo' ),
					'bt-animation-right' => esc_html__( 'Fade In Right', 'bedemo' ),
					'bt-animation-left' => esc_html__( 'Fade In Left', 'bedemo' ),
					'bt-animation-up' => esc_html__( 'Fade In Up', 'bedemo' ),
					'bt-animation-down' => esc_html__( 'Fade In Down', 'bedemo' ),
					'bt-animation-zoom' => esc_html__( 'Zoom In', 'bedemo' ),
				],
			]
		);
		$this->add_responsive_control(
			'animation_delay',
			[
				'label' => __('Animation Delay (ms)', 'bedemo'),
