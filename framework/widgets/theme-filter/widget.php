...
class Widget_ThemeFilter extends Widget_Base
{
	...
	protected function register_layout_section_controls()
	{
		...
		$this->add_control(
			'button_toggle',
			[
				'label' => __('Toggle Button', 'bedemo'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('On', 'bedemo'),
				'label_off' => __('Off', 'bedemo'),
				'default' => 'no',
				'return_value' => 'yes',
			]
		);
				...
				?>
					...
					<?php if ('yes' === $settings['button_toggle'] && $query->found_posts > $settings['posts_per_page']) : ?>
						<div class="bt-button-all">
							<a href="#" data-page="2" class="btn btn-primary"><?php echo esc_attr__('See all Demos', 'bedemo'); ?><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
