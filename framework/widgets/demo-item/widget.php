<?php
namespace BeDemoElementorWidgets\Widgets\DemoItem;
...
class Widget_DemoItem extends Widget_Base {
	...
	protected function register_layout_section_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-demo--item .bt-cover-image' => 'padding-bottom: calc( {{SIZE}} * 100% );',
				],
			]
		);
	...
	protected function register_style_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bt-demo--title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bt-demo--title a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .bt-demo--title',
			]
		);
	...
	protected function render() {
		...
		?>
			<div class="bt-elwg-demo-item--default">
				<div class="bt-demo--item">
					<div class="bt-demo--image">
						<?php echo '<div class="bt-cover-image">' . $image . '</div>'; ?>
					</div>
					<?php 
						if(!empty($settings['title'])) {
							if(!empty($settings['link'])) {
								echo '<h3 class="bt-demo--title">
										<a href="' . esc_url($settings['link']) . '">' . $settings['title'] . '</a>
									</h3>';
							} else {
								echo '<h3 class="bt-demo--title">' . $settings['title'] . '</h3>';
							}
						}
					?>
				</div>
